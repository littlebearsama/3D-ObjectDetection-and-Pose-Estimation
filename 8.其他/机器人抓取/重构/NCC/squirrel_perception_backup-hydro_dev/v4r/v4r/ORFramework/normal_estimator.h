...
#ifndef FAAT_PCL_REC_FRAMEWORK_NORMAL_ESTIMATOR_H_
#define FAAT_PCL_REC_FRAMEWORK_NORMAL_ESTIMATOR_H_
    ...
    template<typename PointInT, typename PointOutT>
      ...
      public:
        ...
        estimate_organized(const PointInTPtr & in, PointInTPtr & out, pcl::PointCloud<pcl::Normal>::Ptr & normals)
        {
            ...
            {
              pcl::ScopeTime t ("compute normals not estimate_organized...");
              n3d.compute (*normals);
            }
        }
