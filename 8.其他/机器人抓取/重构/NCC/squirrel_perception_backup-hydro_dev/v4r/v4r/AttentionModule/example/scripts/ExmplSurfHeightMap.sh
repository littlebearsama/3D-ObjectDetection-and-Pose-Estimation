...
#usage: ../bin/ExmplSurfHeightMap image.png cloud.pcd type pyramid_type combination_type normalization_type
...
# Example: ../bin/ExmplSurfHeightMap image.png cloud.pcd 0 0 0 0
...
function calculateHeightMapBatchProcess {
    for (( i=$1; i<=$2; i=i+1 ))
    do
...
start_image=0
end_image=86
exe_path="/home/ekaterina/work/trunk/bin/ExmplSurfHeightMap"
...
results_path_base='/home/ekaterina/work/db/KLai'
  ...
  do
    ...
    do
      ...
      do
        ...
        results_path=$results_path_base/$sm_type_txt/$sm_type_txt
        results_path=$results_path'_'$pyramid_type_txt'_'$combination_type_txt'_'$normalization_type_txt
        mkdir $results_path
        results_path=$results_path/cloud
        
        calculateHeightMapBatchProcess $start_image $end_image $exe_path $pointclouds_path $rgbimages_path $results_path $add_to_name $sm_type $pyramid_type $combination_type $normalization_type
